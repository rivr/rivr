...
unsigned int nStakeMinAge = 60 * 60 * 24; // 1 days as zero time weight
unsigned int nStakeMaxAge = -1; // 6 month as full weight
unsigned int nModifierInterval = 60; // time to elapse before new modifier is computed

static const int64_t nTargetTimespan = 60 * 1; // 30 blocks  
...
const string strMessageMagic = "Rivrcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Rivrcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Blockchain.info Block #312723 2014-07-27 13:20:25";
        CTransaction txNew;
        txNew.nTime = 1406380825;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
	block.print();
        assert(block.hashMerkleRoot == uint256("0x704b325b041320b9f19f6071e269d0d93a662eb9d0553966fc8f52b50ecc678d"));   
